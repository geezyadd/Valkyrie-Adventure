...
public class BaseEnemyEntity2 : MonoBehaviour
{
//[SerializeField] private EnemyDescriptor _enemyDescriptor;
    ...
    //    _isCloseAttacking = false;
    //}
    //private void SpawnSpellPrephab() { Instantiate(_enemyDescriptor._spellPrephab); }
    ...
    //{
    //    var targetCollider = Physics2D.OverlapCircle(_enemyDescriptor._closeAttackPoint.transform.position, _enemyDescriptor._closeAttackRadius);
    //    if (targetCollider != null && targetCollider.TryGetComponent(out IDamageble damageble)) { damageble.TakeDamage(_enemyDescriptor._closeAttackDamage); }  
    //}
}
